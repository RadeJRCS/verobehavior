...
const faqs = [
  ...
  ['How does the AI work?', 'Our AI engine is purpose-built for behavioral analysis, trained on behavioral psychology literature and session data. It is not a generic chatbot or a wrapper around GPT. Every insight is generated by a domain-specific model designed exclusively for conversion psychology.'],
