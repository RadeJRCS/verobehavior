...
const plans = [
  {
    ...
    desc: 'Explore psychological CRO on your own site. No credit card required.',
    features: ['Up to 10K visitors/month', '1 active experiment', 'Basic behavioral tags', 'Session-level insights', 'Community support'],
    cta: 'Start free', ctaStyle: 'outline' as const, note: 'No credit card required',
  },
  {
    name: 'Starter', price: '149', period: '/mo', badge: null,
    desc: 'For teams getting started with psychology-driven CRO.',
    features: ['Up to 50K visitors/month', '3 concurrent experiments', 'Full psychology dashboard', 'XAI principle citations', 'Behavioral tagging engine', 'Email support'],
    cta: 'Start 14-day trial', ctaStyle: 'outline' as const, note: '14-day free trial included',
  },
  {
    name: 'Professional', price: '449', period: '/mo', badge: 'RECOMMENDED',
    desc: 'The full psychological intelligence stack for growth teams.',
    features: ['Up to 200K visitors/month', 'Unlimited experiments', 'Multi-armed bandit + Judge LLM', 'Psychological persona generation', '4 industry playbooks', 'Brand-voice tuning', 'Priority email + chat support'],
    cta: 'Start 14-day trial', ctaStyle: 'primary' as const, note: 'Most popular for mid-market teams',
  },
  {
    name: 'Business', price: '899', period: '/mo', badge: null,
    desc: 'Advanced features including GEO monitoring and CRM integrations.',
    features: ['Up to 500K visitors/month', 'Everything in Professional', 'GEO / AI visibility monitor', 'CRM integrations (HubSpot, Salesforce)', 'Dynamic content generation', 'Dedicated account manager', 'Phone + priority support'],
    cta: 'Contact us', ctaStyle: 'outline' as const, note: 'For scaling teams with 200K+ visitors',
  },
]
