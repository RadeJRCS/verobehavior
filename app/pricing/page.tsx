  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <div className="pt-24 pb-6 px-6 bg-surface text-center">
        ...
        <p className="text-[16px] text-ink-2 max-w-md mx-auto font-light">VeroBehavior is in private beta. We&apos;re finalizing pricing with our first e-commerce partners, so it reflects real value, not guesswork.</p>
      </div>
      <div className="max-w-5xl mx-auto px-6 py-12 flex-1">
        <div className="grid md:grid-cols-2 gap-6 mb-8">
          <div className="bg-surface-2 border border-surface-3 rounded-2xl p-8 text-center flex flex-col">
            ...
            <p className="text-[15px] text-ink-2 font-light max-w-lg mx-auto mb-6 leading-relaxed flex-1">Full platform access during our private beta, in exchange for feedback and permission to share results. Founding partners lock in a lifetime discount when we launch paid plans.</p>
            <Link href="/contact" className="bg-green text-white px-8 py-3.5 rounded-lg text-[14px] font-semibold hover:opacity-90 inline-block">Apply as design partner</Link>
          </div>

          <div className="bg-surface-2 border border-surface-3 rounded-2xl p-8 text-center flex flex-col">
            <div className="font-serif text-2xl text-ink mb-3">Public pricing: coming soon</div>
            <p className="text-[15px] text-ink-2 font-light max-w-lg mx-auto mb-6 leading-relaxed flex-1">Usage-based, tied to your store&apos;s monthly traffic. No per-seat fees. We&apos;ll publish plans once our partners help us get them right.</p>
