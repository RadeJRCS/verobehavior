...
const sections = [
  ...
  { t: '3. Subscription and billing', p: 'VeroBehavior is currently in private beta. Design partners receive free access in exchange for feedback. Public pricing plans have not launched yet and will be published once we finalize them with our early e-commerce partners. Terms for paid plans, billing, and refunds will be added here once pricing goes live.' },
