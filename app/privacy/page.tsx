...
const sections = [
  ...
  { t: '4. Data retention', p: 'Session data is retained for 90 days by default. Configurable retention periods will be available on paid plans once they launch. All data is encrypted at rest (AES-256) and in transit (TLS 1.3). Upon account termination, all client data is permanently deleted within 30 days.' },
  ...
  { t: '7. Ethical AI commitment', p: 'We do not recommend manipulative or deceptive practices. All AI recommendations are designed to include explainable reasoning (XAI), citing the specific psychological principle behind each suggestion. This is a principle we\'re building toward, not a third-party certification, and we expect our design partners to hold us to it as the product grows.' },
