...
const sections = [
  { t: '1. Introduction', p: 'VeroBehavior ("we", "our", "us") is committed to protecting the privacy of our users and their website visitors. This Privacy Policy explains how we collect, use, and safeguard your data when you use our platform and services.' },
  ...
  { t: '3. How we use data', p: 'Behavioral data is processed by our AI engine to generate psychological insights and conversion optimization recommendations. We do not sell your data or use it to train our own models. Behavioral data is processed by our AI providers under their data protection terms. Individual session data is never shared with third parties, sold, or used for advertising.' },
  { t: '4. Data retention', p: 'We retain session data no longer than necessary for the service, and delete it on request. All data is encrypted at rest (AES-256) and in transit (TLS 1.3).' },
