    ...
    <footer className="bg-[#0E0E14] text-white/40 mt-auto">
      <div className="max-w-6xl mx-auto px-6 py-12">
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8 mb-10">
          ...
          {[{title:'Product',links:[{href:'/demo',l:'Live Demo'},{href:'/pricing',l:'Pricing'},{href:'/docs',l:'Documentation'},{href:'/docs',l:'API Reference'}]},{title:'Solutions',links:[{href:'/demo',l:'Cart abandonment'},{href:'/demo',l:'Checkout drop-off'},{href:'/demo',l:'Product page bounce'}]},{title:'Resources',links:[{href:'/blog',l:'Blog'},{href:'/docs',l:'Help Center'},{href:'/blog',l:'Research'},{href:'/docs',l:'Changelog'},{href:'/contact',l:'Support'}]},{title:'Company',links:[{href:'/about',l:'About'},{href:'/contact',l:'Contact'},{href:'/privacy',l:'Privacy Policy'},{href:'/terms',l:'Terms of Service'},{href:'/about',l:'Ethical AI Charter'}]}].map(col => (
