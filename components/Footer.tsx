      ...
      <div className="max-w-6xl mx-auto px-6 py-12">
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8 mb-10">
          <div className="col-span-2 md:col-span-1">
            ...
            <div className="inline-flex items-center gap-2 bg-[#1D9E75]/15 border border-[#1D9E75]/30 rounded-md px-3 py-1.5 text-[10px] text-[#5DCAA5] font-mono">✓ Ethical AI: our commitment</div>
          </div>
          {[{title:'Product',links:[{href:'/demo',l:'Live Demo'},{href:'/pricing',l:'Pricing'},{href:'/docs',l:'Documentation'},{href:'/docs#api-reference',l:'API Reference'}]},{title:'Solutions',links:[{href:'/demo',l:'Cart abandonment'},{href:'/demo',l:'Checkout drop-off'},{href:'/demo',l:'Product page bounce'}]},{title:'Resources',links:[{href:'/blog',l:'Blog'},{href:'/contact',l:'Help Center'},{href:'/docs#changelog-and-faq',l:'Changelog'},{href:'/contact',l:'Support'}]},{title:'Company',links:[{href:'/about',l:'About'},{href:'/contact',l:'Contact'},{href:'/privacy',l:'Privacy Policy'},{href:'/terms',l:'Terms of Service'},{href:'/about',l:'Ethical AI'}]}].map(col => (
